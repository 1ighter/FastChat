class nsfw:
    def __init__(self):
        self.ban_words = ['充气妹', '平成元年', '改号软件', '芳香疗法', '股权激励',
                          ...
                          '一元购', '高频以太', '代考', '微商', '共同妄想', 'BoysLove',
                          '清除负面新闻', 'X日女友', '小艾斯', '接触魔法', '能量治疗', '个股推荐',
                          '宗教用品', '崔健', '偷电', '64', 'ASMR（颅内高潮）', '长安街', '三十多年前',
                          ...
                          '赌石行为', '李小鹏', '六月的广场', '和谐能量', '搜索引擎排名作弊', '刘霞', 'GV', '疫苗',
                          '广场上数千人的鲜血', '一块红布', 'NFT', '百年空椅', '原油交易', '卢恩魔法', '419',
                          ...
                          '信用卡套现', '股票配资', '遍地烛光', '塔罗魔法', 'KKP', '89', 'G点', '丧葬殡仪', '一元夺宝',
                          ...
                          '宠物盲盒', '代孕', '亲子鉴定', '6月的那件事', 'POS机', '远程疗法', 'P2P', '凯尔特尔',
                          ...
                          '国家级新药', '侯德健', '佐药治疗', '五四青年节延后一个月', 'BL', '私服', '本子', '撸撸杯',
                          '消失的一天', '刘晓波', '男用情趣', '热血在广场', '情商学', '飞机杯', '假财务票据', '违章代缴费',
                          '89动乱', '国家保护野生动物', '无刺激', '紫微斗数', '活体出售', '掷爻', 'R18', '攻受', '六四',
